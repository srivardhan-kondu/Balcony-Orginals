...
// A metal's colour tints what it reflects: near-white chrome, so the mark reads
// bright against the black page.
const MATERIAL = { color: 0xf2f2f2, roughness: 0.18, exposure: 1.15 };
